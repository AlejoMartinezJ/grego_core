...
@Component
public class LocationCheckPointHandler {

	@Autowired
	private ILocationCheckpointService service;
	...
	public Mono<ServerResponse> listar(ServerRequest req){
		return ServerResponse
				...
				.body(service.listar(), LocationCheckpoint.class);
	}
	...
	public Mono<ServerResponse> registrar(ServerRequest req){
		...
		Mono<LocationCheckpoint> company = req.bodyToMono(LocationCheckpoint.class);
		return company
	...
	public Mono<ServerResponse> modificar(ServerRequest req){
		...
		Mono<LocationCheckpoint> request = req.bodyToMono(LocationCheckpoint.class);
