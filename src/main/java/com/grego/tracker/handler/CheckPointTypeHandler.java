...
@Component
public class CheckPointTypeHandler {

	@Autowired
	private ICheckpointTypeService service;
	...
	public Mono<ServerResponse> listar(ServerRequest req){
		return ServerResponse
				...
				.body(service.listar(), CheckPointType.class);
	}
	...
	public Mono<ServerResponse> registrar(ServerRequest req){
		...
		Mono<CheckPointType> request = req.bodyToMono(CheckPointType.class);
		return request
